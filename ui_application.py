...
class Ui_NegarHosseiniThesis(object):
    def setupUi(self, NegarHosseiniThesis):
        NegarHosseiniThesis.setObjectName("NegarHosseiniThesis")
        NegarHosseiniThesis.resize(1656, 825)
        NegarHosseiniThesis.setAcceptDrops(False)
        self.centralwidget = QtWidgets.QWidget(NegarHosseiniThesis)
        ...
        NegarHosseiniThesis.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(NegarHosseiniThesis)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1656, 21))
        self.menubar.setObjectName("menubar")
        NegarHosseiniThesis.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(NegarHosseiniThesis)
        self.statusbar.setObjectName("statusbar")
        NegarHosseiniThesis.setStatusBar(self.statusbar)

        self.retranslateUi(NegarHosseiniThesis)
        self.load_image.clicked.connect(self.loadImage) # type: ignore
        self.predict.clicked.connect(self.model_predict) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(NegarHosseiniThesis)
    ...
    def retranslateUi(self, NegarHosseiniThesis):
        _translate = QtCore.QCoreApplication.translate
        NegarHosseiniThesis.setWindowTitle(_translate("NegarHosseiniThesis", "Negar Hosseini Thesis"))
        self.load_image.setText(_translate("NegarHosseiniThesis", "load image"))
        self.predict.setText(_translate("NegarHosseiniThesis", "predict"))
        self.show_predictions.setText(_translate("NegarHosseiniThesis", "prediction"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    NegarHosseiniThesis = QtWidgets.QMainWindow()
    ui = Ui_NegarHosseiniThesis()
    ui.setupUi(NegarHosseiniThesis)
    NegarHosseiniThesis.show()
    sys.exit(app.exec_())
